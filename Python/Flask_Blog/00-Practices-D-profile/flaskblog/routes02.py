...
from flaskblog.forms02 import RegistrationForm, LoginForm, UpdateAccountForm
...
def account() :
    ...
    return render_template('account02.html', title='Account', image_file=image_file, form=form)